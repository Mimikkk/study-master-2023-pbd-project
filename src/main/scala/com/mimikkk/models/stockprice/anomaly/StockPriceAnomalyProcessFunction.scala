...
final class StockPriceAnomalyProcessFunction extends ProcessWindowFunction[StockPriceAnomalyAggregator.Result, StockPriceAnomalyProcessFunction.Result, String, TimeWindow] {
